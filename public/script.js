...
export const systemUserName = 'DreamTavern System';
...
export let displayVersion = 'DreamTavern';
...
export let CLIENT_VERSION = 'DreamTavern:UNKNOWN:DreamWeaver'; // For Horde header
...
async function getClientVersion() {
    try {
        ...
        displayVersion = `DreamTavern is on ${data.pkgVersion}`;
        currentVersion = data.pkgVersion;

        // Branch info hidden for DreamTavern
...
jQuery(async function () {
    ...
    // Checks every 30s for new character push notifications from admin
    setInterval(async () => {
        try {
